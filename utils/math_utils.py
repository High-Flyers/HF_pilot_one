...
# print("{:.4f}, {:.4f}, {:.4f}\n, {:.4f}, {:.4f}, {:.4f},\n{:.4f}, {:.4f}, {:.4f}".format(
#       drone_transform[0, 0], drone_transform[0, 1], drone_transform[0, 2],
#       drone_transform[1, 0], drone_transform[1, 1], drone_transform[1, 2],
#       drone_transform[2, 0], drone_transform[2, 1], drone_transform[2, 2]))
